  ...
  units: [
    Unit(
      ...
      items: [
        ...
        Flashcard(
          japanese: 'そば',
          meaning: 'soba; Japanese buckwheat noodles',
        ),
        Flashcard(
          japanese: 'え',
        ...
        Flashcard(
          japanese: 'つきあう',
          meaning: 'to date (someone); to keep company',
        ),
        Flashcard(
          japanese: 'つく',
          meaning: 'to arrive',
        ...
        Flashcard(
          japanese: 'はっぴょうする',
          meaning: 'to make a presentation; to make public',
        ),
        Flashcard(
          japanese: '～けど',
          meaning: '. . . , but; . . . , so',
        ...
        Flashcard(
          japanese: 'たのしみです',
          meaning: 'cannot wait; to look forward to it',
        ),
      ],
    ),
    Unit(
